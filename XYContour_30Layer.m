%% Plotting the zero velocity curve XY for 30 Mascon Layer

cd('C:/Users/tewki/Downloads/Summer Research/Data_Apophis');
Mascon_30 = load('Mascon_30_data.dat');
layers_30 = load('points_tetrahedron_center.dat');
...
title('XY Projection of Zero Velocity Curves for 30 Mascon Layer');
...
print('equilibrium_xy_30layer','-djpeg');